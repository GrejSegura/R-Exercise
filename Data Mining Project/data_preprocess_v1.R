...
regionData <- read.csv2("./Regional Grouping.csv", sep = ",", na.strings = c(" ", ""))  ### data for regional groups
...
dta_1 <- read.csv2("./BIG5 ATD 2016.csv", sep = ",", na.strings = c(" ", ""))  ### data for attended
dta_1$label <- 1

dta_2 <- read.csv2("./BIG5 NS 2016.csv", sep = ",", na.strings = c(" ", ""))  ### data for no shows
dta_2$label <- 0
...
write.csv(dta_clean, "./big5_cleanData.csv", row.names = FALSE)
##############################################################################################################

## Part 2 ##
rm(list = ls()) ## clear the memory

codeData <- read.csv2("./BIG5 CODES 2016.csv", sep = ",", na.strings = c(" ", ""))  ### data for codes
...
dtaMiningRaw <- read.csv2("./big5_cleanData.csv", sep = ",", na.strings = c(" ", ""))  ### data for codes
...
write.csv(dtaMining, "./dtaminingClean.csv", row.names = FALSE)
